...
export class EventService {
  ...
  async getEvents(query) {
    ...
    const [data, total] = await Promise.all([
      this.eventRepository.findAllEvents(filter, {
        skip,
        limit: currentLimit,
        sort: sortObject
      }),
  ...
  async updateEvent(id, data, user) {
    ...
    return this.eventRepository.updateEventById(id, updateData);
  }
  ...
  async changeStatus(id, status, user) {
    ...
    return this.eventRepository.updateEventById(id, { status });
  }
}