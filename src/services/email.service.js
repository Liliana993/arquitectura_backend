...
// 2. Exportamos una función asíncrona que recibe los datos necesarios para personalizar el mensaje.
export const sendTicketConfirmationEmail = async (to, userName, eventTitle, ticketCode) => {

    try {

        // Llamamos al método 'sendMail' para construir y
        // despachar el correo hacia el servidor externo (Gmail/SendGrid), el cual completará el envío.
        await transporter.sendMail({
            from: process.env.MAIL_FROM,
            to,
            subject: "Confirmación de reserva de ticket",
            // Acá me asistí de una AI para darle estilo al cuerpo de email,
            // pero básicamente, dentro del cuerpo del email, se muestra solamente:
            // el nombre del usuario, el nombre del evento y el código del ticket.
            html: `
